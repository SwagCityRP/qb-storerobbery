...
Config.Registers = {
    ...
    [12] = {vector3(374.62, 327.55, 103.57), robbed = false, time = 0, safeKey = 8, camId = 11}, -- 7093 right
...
Config.Safes = {
    ...
    [8] = {vector3(380.99, 332.39, 103.57), type = "keypad", robbed = false, camId = 11}, -- 7093
